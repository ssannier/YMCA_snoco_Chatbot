    ...
    <div className={cn("content-stretch flex flex-col items-start relative size-full min-h-screen bg-[#E1F4FA]")}>
      ...
      <div className={cn("content-stretch flex flex-col items-center justify-center px-[100px] py-0 relative shrink-0 w-full")}>
        <div className={cn("content-stretch flex items-center justify-between px-[24px] py-[24px] relative shrink-0 w-full")}>
          <div className={cn("h-[72px] relative shrink-0 w-[94.161px]")}>
            <img alt="YMCA Logo" className="absolute inset-0 max-w-none object-center object-cover pointer-events-none size-full" src={ymcaLogo} />
          </div>
            ...
            <div className="content-stretch flex flex-col items-center justify-center relative shrink-0 w-full">
              <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
                ...
                <div className="content-stretch flex gap-[24px] items-start max-w-[1200px] relative shrink-0 w-full">
                  {/* Card 1 - Crisis */}
                  <Link href="/chat" className={cn("basis-0 bg-white border border-[#d1d5dc] border-solid content-stretch flex grow items-center min-h-px min-w-px px-[16px] py-[16px] relative rounded-[12px] shrink-0 hover:border-[#EE3124] transition-colors cursor-pointer")}>
                  ...
                  <Link href="/chat" className={cn("basis-0 bg-white border border-[#d1d5dc] border-solid content-stretch flex flex-col grow items-start min-h-px min-w-px relative rounded-[12px] shrink-0 hover:border-[#00AEEF] transition-colors cursor-pointer")}>
                ...
                <div className="content-stretch flex gap-[24px] items-start max-w-[1200px] relative shrink-0 w-full">
                  {/* Card 3 - Leadership */}
                  <Link href="/chat" className={cn("basis-0 bg-white border border-[#d1d5dc] border-solid content-stretch flex flex-col grow items-start min-h-px min-w-px relative rounded-[12px] shrink-0 hover:border-[#92278F] transition-colors cursor-pointer")}>
                    <div className={cn("content-stretch flex flex-col gap-[12px] items-start p-[16px] relative shrink-0 w-full")}>
                      <div className={cn("content-stretch flex gap-[8px] items-center relative shrink-0 w-full")}>
                        <div className="relative shrink-0 size-[40px]">
                          <UsersIcon />
                  ...
                  {/* Card 4 - Innovation */}
                  <Link href="/chat" className={cn("basis-0 bg-white border border-[#d1d5dc] border-solid content-stretch flex flex-col grow items-start min-h-px min-w-px relative rounded-[12px] shrink-0 hover:border-[#FDB913] transition-colors cursor-pointer")}>
                    <div className={cn("content-stretch flex flex-col gap-[12px] items-start p-[16px] relative shrink-0 w-full")}>
                      <div className={cn("content-stretch flex gap-[8px] items-center relative shrink-0 w-full")}>
                        <div className="relative shrink-0 size-[40px]">
                          <LightbulbIcon />
